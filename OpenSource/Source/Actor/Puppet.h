...
geBoolean  GENESISCC gePuppet_RenderThroughFrustum(
	const gePuppet     *P, 
	const gePose       *Joints, 
	const geExtBox     *Box, 
	      geEngine     *Engine, 
...
geBoolean  GENESISCC gePuppet_Render(
	const gePuppet *P,
	const gePose   *Joints,
	      geEngine *Engine, 
	      geWorld  *World,
...
geBoolean  GENESISCC gePuppet_GetMaterial( 
	gePuppet  *P, 
	int        MaterialIndex,
	geBitmap **Bitmap, 
	geFloat   *Red, 
...
geBoolean  GENESISCC gePuppet_SetMaterial(
	gePuppet *P, 
	int       MaterialIndex, 
	geBitmap *Bitmap, 
	geFloat   Red, 
...
void       GENESISCC gePuppet_SetShadow(
	      gePuppet  *P, 
	      geBoolean  DoShadow, 
	      geFloat    Scale, 
...
void        GENESISCC gePuppet_SetLightingOptions(
	      gePuppet  *P,
	      geBoolean  UseFillLight,
