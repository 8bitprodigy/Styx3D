...
geBoolean GENESISCC 
geVKFrame_LinearRead(geVFile* pFile, void* geVKFrame)
{
	uint32	u;
	char	KeyString[64];
...
geBoolean GENESISCC 
geVKFrame_HermiteRead(geVFile* pFile, void* geVKFrame)
{
	uint32	u;
...
geTKArray *GENESISCC 
geVKFrame_CreateFromFile(geVFile *pFile, geVKFrame_InterpolationType *InterpolationType, int *Looping)
{
...
uint32 GENESISCC 
geVKFrame_ComputeBlockSize(geTKArray *KeyList, int Compression)
{
	uint32 Size=0;
	int Count;
...
geTKArray *GENESISCC 
geVKFrame_CreateFromBinaryFile(geVFile *pFile, geVKFrame_InterpolationType *InterpolationType, int *Looping)
{
	uint32 u;
	int BlockSize;
	int Compression;
