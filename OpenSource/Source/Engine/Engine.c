...
#define WIN32_LEAN_AND_MEAN
    ...
    #define getcwd _getcwd  // Map Windows `_getcwd` to `getcwd`
...
static geBoolean Engine_InitDriver(
	geEngine      *Engine, 
	geDriver      *Driver,
...
//===================================================================================
geBoolean 
geEngine_Puts(geEngine *Engine, int32 x, int32 y, const char *String)
{
	Sys_FontInfo	*Fi;
...
geEngine_Printf(geEngine *Engine, int32 x, int32 y, const char *String, ...)
{
	va_list ArgPtr;
    char    TempStr[1024];
