...
extern uint8_t    LogoActor_act[];
extern int        LogoActor_act_Length;
extern uint8_t    Corona_bmp[];
extern int        Corona_bmp_Length;
extern uint8_t    Streak_bmp[];
extern int        Streak_bmp_Length;
extern uint8_t    WebUrl_bmp[];
extern int        WebUrl_bmp_Length;
extern uint8_t    A_Corona_bmp[];
extern int        A_Corona_bmp_Length;
extern uint8_t    A_Streak_bmp[];
