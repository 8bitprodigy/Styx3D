...
#include "PolyCache.h"
#include "D3D9Log.h"
//#include "D3D9Render.h" // commenting out all refs to D3DRender. It was intended to replace this file... but no.
...
//	commenting out ref to D3DRender -- not using.
...
jeBoolean DRIVERCC D3D9Drv_EnumPixelFormats(DRV_ENUM_PFORMAT_CB* Cb, void* Context)
{
	...
	//else
	Format3d = JE_PIXELFORMAT_16BIT_565_RGB;	//	Do we really want to force this format?
